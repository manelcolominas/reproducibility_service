...
FLAG_DEFINITIONS: tuple[FlagDefinition, ...] = (
    ...
    FlagDefinition("--graph", "Enable graph generation shortcut.", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--tracing", "Set generation of traces.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--monitoring", "Period between monitoring samples in (milliseconds).", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--external_debugger", "Enables external debugger connection on the specified port (or 9999 if empty).", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--jmx_port", "Enable JVM profiling on specified port.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--task_execution", "Task execution under COMPSs or Storage. Default: compss", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    ...
    FlagDefinition("--storage_conf", "Path to the storage configuration file.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--project", "Path to the COMPSs project file.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--resources", "Path to the COMPSs resources file.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--socket", "Socket name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--summary", "Print a summary of the COMPSs execution.", (ExecutionBackend.LOCAL,), FlagValueKind.NONE),
    FlagDefinition("--extrae_config_file", "Path to the Extrae configuration file.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--extrae_config_file_python", "Path to the Extrae configuration file for Python.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--trace_label", "Label for the generated trace.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--tracing_task_dependencies", "Enable tracing of task dependencies (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--generate_trace", "Enable tracing of task dependencies.", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--delete_trace_packages", "Delete trace packages after execution (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--custom_threads", "Enable custom threads for the COMPSs runtime (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--comm", "Communication implementation class name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--conn", "Connection implementation class name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--streaming", "Enable streaming for the COMPSs runtime (type: TCP, UDP, etc.).", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--streaming_master_name", "Master name for the streaming implementation.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--streaming_master_port", "Master port for the streaming implementation.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--scheduler", "Scheduler implementation class name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--scheduler_config_file", "Path to the scheduler configuration file.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--checkpoint", "Checkpoint implementation class name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--checkpoint_params", "Parameters for the checkpoint implementation.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--checkpoint_folder", "Folder for storing checkpoints.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--library_path", "Path to the library for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--classpath", "Path to the classpath for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--appdir", "Path to the application directory for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--env_script", "Path to the environment script for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--log_dir", "Path to the log directory for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--master_working_dir", "Path to the master working directory for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--uuid", "UUID for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--master_name", "Master name for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--master_port", "Master port for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--jvm_master_opts", "JVM options for the master process of the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--jvm_workers_opts", "JVM options for the worker processes of the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--cpu_affinity", "CPU affinity for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--gpu_affinity", "GPU affinity for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--fpga_affinity", "FPGA affinity for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--fpga_reprogram", "FPGA reprogramming command for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    ...
    FlagDefinition("--task_count", "Number of tasks for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--input_profile", "Path to the input profile for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--output_profile", "Path to the output profile for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
    FlagDefinition("--PyObject_serialize", "Enable or disable PyObject serialization (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--persistent_worker_c", "Enable or disable persistent worker for C tasks (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--enable_external_adaptation", "Enable or disable external adaptation (true/false). ", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--gen_coredump", "Enable or disable core dump generation", (ExecutionBackend.LOCAL,), FlagValueKind.NONE),
    FlagDefinition("--keep_workingdir", "Keep the working directory after execution.", (ExecutionBackend.LOCAL,), FlagValueKind.NONE),
    FlagDefinition("--python_interpreter", "Path to the Python interpreter for the COMPSs runtime.", (ExecutionBackend.LOCAL,), FlagValueKind.STRING, prefer_equals=True),
    FlagDefinition("--python_propagate_virtual_environment", "Enable or disable propagation of the Python virtual environment (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--python_mpi_worker", "Enable or disable MPI worker for Python tasks (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--python_memory_profile", "Enable or disable memory profiling for Python tasks (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--python_cache_profiler", "Enable or disable cache profiling for Python tasks (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    FlagDefinition("--wall_clock_limit", "Set the wall clock limit for the COMPSs runtime in seconds.", (ExecutionBackend.LOCAL,), FlagValueKind.INT, prefer_equals=True),
    FlagDefinition("--shutdown_in_node_failure", "Enable or disable shutdown in node failure (true/false).", (ExecutionBackend.LOCAL,), FlagValueKind.BOOL, prefer_equals=True),
    ...
    FlagDefinition("--provenance_folder", "Folder to store the generated provenance data in RO-Crate format.", (ExecutionBackend.LOCAL,), FlagValueKind.PATH, prefer_equals=True),
